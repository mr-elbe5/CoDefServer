...
<li class="<%=liClass%>">
    ...
    <div class="icons">
        ...
        <a class="icon fa fa-plus" onclick="return openModalDialog('/ctrl/content/openCreateBackendContent?parentId=<%=contentData.getId()%>&type=de.elbe5.defect.DefectData');" title="<%=$SH("_newDefect")%>"></a>
    </div>
    <%}%>
    <ul>
