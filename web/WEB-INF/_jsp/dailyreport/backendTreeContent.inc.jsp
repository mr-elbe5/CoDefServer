...
<li class="<%=liClass%>">
    ...
    <div class="icons">
        <a class="icon fa fa-pencil" href="" onclick="return openModalDialog('/ctrl/dailyreport/openEditBackendContent/<%=contentData.getId()%>');" title="<%=$SH("_edit")%>"> </a>
    ...
    <%}%>
    <ul>
        <jsp:include page="/WEB-INF/_jsp/dailyreport/backendTreeContentImages.inc.jsp" flush="true" />
    </ul>
</li>
