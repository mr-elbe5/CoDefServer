                ...
                <li class="<%=fileId==image.getId() ? "current" : ""%>">
                    <div class="treeline">
                        ...
                        <div class="icons">
                            ...
                            <a class="icon fa fa-plus" onclick="return openModalDialog('/ctrl/file/openCreateFile?parentId=<%=contentData.getId()%>&type=de.elbe5.file.ImageData');" title="<%=$SH("_newImage")%>"></a>
                        </div>
                    </div>
                </li>
                <%
