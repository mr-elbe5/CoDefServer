...
<li class="<%=liClass%>">
    ...
    <div class="icons">
        ...
        <a class="icon fa fa-plus" onclick="return openModalDialog('/ctrl/defectstatuschange/openCreateBackendContent?parentId=<%=contentData.getId()%>&type=de.elbe5.defectstatuschange.DefectStatusChangeData');" title="<%=$SH("_newDefectStatus")%>"></a>
    </div>
    <%}%>
    <ul>
        <jsp:include page="/WEB-INF/_jsp/defect/backendTreeContentImages.inc.jsp" flush="true" />
